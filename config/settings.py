...
SECRET_KEY = os.getenv(
    'SECRET_KEY',
    'django-insecure-qms-hub-super-secret-key-development-mode-2026'
)
...
# Email Alert Configuration (SMTP & Fallback)
...
DEFAULT_FROM_EMAIL = os.getenv('DEFAULT_FROM_EMAIL', 'QMS Hub <alerts@qms-hub.local>')
